...
!define VERSION "2.0" # AUTO_VERSION
...
Section "OpenVPN RSA Certificate Management Scripts" SecOpenVPNEasyRSA
  ...
  File "${MASTER}\easy-rsa\Windows\vars.bat.sample"

  File "${MASTER}\easy-rsa\Windows\init-config.bat"

  File "${MASTER}\easy-rsa\Windows\README.txt"
  File "${MASTER}\easy-rsa\Windows\build-ca.bat"
  File "${MASTER}\easy-rsa\Windows\build-dh.bat"
  File "${MASTER}\easy-rsa\Windows\build-key-server.bat"
  File "${MASTER}\easy-rsa\Windows\build-key.bat"
  File "${MASTER}\easy-rsa\Windows\build-key-pkcs12.bat"
  File "${MASTER}\easy-rsa\Windows\clean-all.bat"
  File "${MASTER}\easy-rsa\Windows\index.txt.start"
  File "${MASTER}\easy-rsa\Windows\revoke-full.bat"
  File "${MASTER}\easy-rsa\Windows\serial.start"
